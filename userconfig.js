      ...
      categories: [
        {
          ...
          links: [
            ...
            {
              name: "home-nas",
              url: "https://cloud.home-nas.space:5001",
              icon: "cloud-data-connection",
              icon_color: "#6c8dbf",
            },
            {
              name: "cloud-drive",
              url: "https://cloud.home-nas.space:5001/drive",
              icon: "server-2",
              icon_color: "#ea6962",
            },
            {
              name: "gitea",
              url: "https://cloud.home-nas.space:5551",
              icon: "git-pull-request",
              icon_color: "#7daea3",
            },
            {
              name: "jenkins",
              url: "https://cloud.home-nas.space:5552/",
              icon: "brand-codesandbox",
              icon_color: "#ea6962",
            },
            {
              name: "vaultwarden",
              url: "https://cloud.home-nas.space:5555/",
              icon: "key",
              icon_color: "#6c8dbf",
            },
            {
              name: "mattermost",
              url: "https://cloud.home-nas.space:5550/",
              icon: "brand-slack",
              icon_color: "#d3869b",
            },
            {
              name: "syno-chat",
              url: "https://cloud.home-nas.space:5001/chat",
              icon: "brand-line",
              icon_color: "#7daea3",
            },
            {
